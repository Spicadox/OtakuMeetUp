...
router.post(['/savedConnections'], function (req, res) {
    ...
    if (req.session.previousPath == "/connection") {
        ...
        let newConnection = new Connection(parsedConnection._id, parsedConnection.title, parsedConnection.category, parsedConnection.details, parsedConnection._dateTime, parsedConnection._location);
