...
userProfileSchema.methods.addConnection = function (userConnection) {
    ...
    UserProfile.findOneAndUpdate({ _id: this._id }, { userConnections: userConnection }, options.upsert).populate({ path: 'userConnections', model: 'userConnection' }).exec(function (err, updatedUserProfile) {
