...
userProfileSchema.methods.addConnection = function (newUserProfile, userConnection) {
    ...
    return new Promise(function (resolve, reject,) {
        ...
        UserProfile.findById({ _id: Mongoose.Types.newUserProfile._id }, 'userConnections').populate({ path: 'userConnections', model: 'userConnection' }).exec(function (userConnections) {
