...
userProfileSchema.methods.addConnection = function (newUserProfile, userConnection) {
    ...
    return new Promise(function (resolve, reject,) {
        ...
        UserProfile.findOneAndUpdate({ _id: this._id }, { $set: { userConnections: userConnection }, $setOnInsert: { user: newUserProfile.user, _id: newUserProfile._id } }, { upsert: true, returnOriginal: false })
