...
userProfileSchema.methods.addConnection = function (newUserProfile, userConnection) {
    ...
    return new Promise(function (resolve, reject,) {
        ...
        console.log(typeOf(newUserProfile._id))
        console.log(mongoose.Types.ObjectId(newUserProfile._id))
        UserProfile.findById({ _id: mongoose.Types.ObjectId(newUserProfile._id) }, 'userConnections').populate({ path: 'userConnections', model: 'userConnection' }).exec(function (userConnections) {
