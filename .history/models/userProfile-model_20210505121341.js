...
userProfileSchema.methods.addConnection = function (newUserProfile, userConnection) {
    ...
    return new Promise(function (resolve, reject,) {
        ...
        UserProfile.findOne({ _id: mongoose.Types.ObjectId(newUserProfile._id) }, 'userConnections').populate({ path: 'userConnections', model: 'userConnection' }).exec(function (userConnections) {
