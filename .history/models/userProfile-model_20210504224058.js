...
userProfileSchema.methods.addConnection = function (userProfile, userConnection) {
    // let id = this._id;
    return new Promise(function (resolve, reject) {
        console.log(this.user)

        UserProfile.findOneAndUpdate({ _id: userProfile._id }, { $set: { userConnections: userConnection }, $setOnInsert: { user: userProfile.user, _id: userProfile._id } }, { upsert: true })
