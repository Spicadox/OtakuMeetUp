...
class UserProfile {
    ...
    // Method takes the connectionID which is used to find the specific user connection and rsvp value 
    // is the new value that will replace the old rsvp value 
    ...
    // Method that returns the list of user connections
    getUserConnections() {
